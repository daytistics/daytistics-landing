<template>
    ...
    >
        <p>
            We're working tirelessly to bring Daytistics to life and can't wait
            to share it with you. If you'd like to follow our journey or be
            among the first to know when Daytistics launches, subscribe to our

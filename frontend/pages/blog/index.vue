<template>
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div v-else-if="blogs.length < 1" class="flex justify-center">
                <span class="font-bold text-3xl"> No blogs found :(</span>
            </div>
    ...
    () => {
        const filters = blogs
            ...
            .reduce((acc, id, index) => {
                ...
                return (
                    acc + `filters[documentId][$in]=${encodeURIComponent(id)}`
                );
            }, "")
            .toString();
